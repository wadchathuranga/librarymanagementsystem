...
namespace librarymanagementsystem {
    ...
    public partial class librarysystemDataSet1 : global::System.Data.DataSet {
        ...
        public partial class BooksDataTable : global::System.Data.TypedTableBase<BooksRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
            public BooksRow AddBooksRow(string Classification, string Title, string Publisher, string Status, string Author, string BookId) {
            ...
            public string BookId {
                get {
                    try {
                        ...
                        throw new global::System.Data.StrongTypingException("The value for column \'BookId\' in table \'Books\' is DBNull.", e);
                    }
                }
                set {
...
namespace librarymanagementsystem.librarysystemDataSet1TableAdapters {
    ...
    public partial class BooksTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = @"DELETE FROM [dbo].[Books] WHERE (([Id] = @Original_Id) AND ((@IsNull_Classification = 1 AND [Classification] IS NULL) OR ([Classification] = @Original_Classification)) AND ((@IsNull_Title = 1 AND [Title] IS NULL) OR ([Title] = @Original_Title)) AND ((@IsNull_Publisher = 1 AND [Publisher] IS NULL) OR ([Publisher] = @Original_Publisher)) AND ((@IsNull_Status = 1 AND [Status] IS NULL) OR ([Status] = @Original_Status)) AND ((@IsNull_Author = 1 AND [Author] IS NULL) OR ([Author] = @Original_Author)) AND ((@IsNull_BookId = 1 AND [BookId] IS NULL) OR ([BookId] = @Original_BookId)))";
            ...
            this._adapter.InsertCommand.CommandText = @"INSERT INTO [dbo].[Books] ([Classification], [Title], [Publisher], [Status], [Author], [BookId]) VALUES (@Classification, @Title, @Publisher, @Status, @Author, @BookId);
SELECT Id, Classification, Title, Publisher, Status, Author, BookId FROM Books WHERE (Id = SCOPE_IDENTITY())";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[Books] SET [Classification] = @Classification, [Title] = @Title, [Publisher] = @Publisher, [Status] = @Status, [Author] = @Author, [BookId] = @BookId WHERE (([Id] = @Original_Id) AND ((@IsNull_Classification = 1 AND [Classification] IS NULL) OR ([Classification] = @Original_Classification)) AND ((@IsNull_Title = 1 AND [Title] IS NULL) OR ([Title] = @Original_Title)) AND ((@IsNull_Publisher = 1 AND [Publisher] IS NULL) OR ([Publisher] = @Original_Publisher)) AND ((@IsNull_Status = 1 AND [Status] IS NULL) OR ([Status] = @Original_Status)) AND ((@IsNull_Author = 1 AND [Author] IS NULL) OR ([Author] = @Original_Author)) AND ((@IsNull_BookId = 1 AND [BookId] IS NULL) OR ([BookId] = @Original_BookId)));
SELECT Id, Classification, Title, Publisher, Status, Author, BookId FROM Books WHERE (Id = @Id)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::librarymanagementsystem.Properties.Settings.Default.librarysystemConnectionString;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT Id, Classification, Title, Publisher, Status, Author, BookId FROM dbo.Book" +
                "s";
        ...
        public virtual int Fill(librarysystemDataSet1.BooksDataTable dataTable) {
        ...
        public virtual librarysystemDataSet1.BooksDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            librarysystemDataSet1.BooksDataTable dataTable = new librarysystemDataSet1.BooksDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(librarysystemDataSet1.BooksDataTable dataTable) {
        ...
        public virtual int Delete(int Original_Id, string Original_Classification, string Original_Title, string Original_Publisher, string Original_Status, string Original_Author, string Original_BookId) {
            ...
            if ((Original_BookId == null)) {
                ...
                this.Adapter.DeleteCommand.Parameters[12].Value = ((string)(Original_BookId));
            }
        ...
        public virtual int Insert(string Classification, string Title, string Publisher, string Status, string Author, string BookId) {
            ...
            if ((BookId == null)) {
                ...
                this.Adapter.InsertCommand.Parameters[5].Value = ((string)(BookId));
            }
        ...
        public virtual int Update(string Classification, string Title, string Publisher, string Status, string Author, string BookId, int Original_Id, string Original_Classification, string Original_Title, string Original_Publisher, string Original_Status, string Original_Author, string Original_BookId, int Id) {
            if ((Classification == null)) {
            ...
            if ((BookId == null)) {
                ...
                this.Adapter.UpdateCommand.Parameters[5].Value = ((string)(BookId));
            }
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string Classification, string Title, string Publisher, string Status, string Author, string BookId, int Original_Id, string Original_Classification, string Original_Title, string Original_Publisher, string Original_Status, string Original_Author, string Original_BookId) {
            return this.Update(Classification, Title, Publisher, Status, Author, BookId, Original_Id, Original_Classification, Original_Title, Original_Publisher, Original_Status, Original_Author, Original_BookId, Original_Id);
        }
    }
